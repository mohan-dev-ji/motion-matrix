...
export const SEEK_4_DURATION = 705;

const PROMPT = "motiomatrix@v.0.0.2 ~ %";
const RANGE = { min: -10, max: 10 };
const TARGET = 4;
const TERM = { widthPct: 0.62, heightPct: 0.34, xPct: 0.19, yPct: 0.13 };

// Timeline (705 frames = 23.5s).
// 0-300: setup (load, line draws, ticks fade in, type "seek -7")
// 305-365: "Thinking..." types in (60-frame typewriter)
// 305-480: 6s "thinking" pause
// 480-525: glow travels 0 → -7 + arrow grows
// 525: solid drop + "target found: -7"
// 525-705: 6s hang on the answer
const TRAVEL_START = 480;
const TRAVEL_DURATION = 45;
const ANSWER_FRAME = TRAVEL_START + TRAVEL_DURATION;

export const Seek4: React.FC = () => {
